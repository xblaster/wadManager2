...
var api = require('./controllers/api'),
    ...
    budgets = require('./controllers/budgets'),
...
module.exports = function(app) {
  ...
  app.route('/budget/save').post(budgets.save);
  app.route('/budget/get').get(budgets.get);

  app.route('/entry/excel').get(entry.excel);

  app.route('/entry/save').post(entry.save);
  app.route('/entry/listTags').get(entry.listTags);
